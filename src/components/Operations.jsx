...
const Operations = () => {
  return (
    <div>
       <section className='bg-[#F7F7F7] pb-[3rem] py-[3rem] mx-[4.8rem]'>
        <h1 className='text-[3rem] text-center text-[#1A7122] mb-4 font-semibold'>Areas of Operation</h1>
        <div className="flex justify-between gap-4 items-center ">
            {/* left features */}
            <div className="flex flex-col gap-4 py-4 w-[40%]">
